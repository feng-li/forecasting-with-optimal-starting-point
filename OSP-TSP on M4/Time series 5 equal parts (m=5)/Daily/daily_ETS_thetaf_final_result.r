...
ets_datalist <- load_single_object('Daily_ets_datalist.RData')
thetaf_datalist <- load_single_object('Daily_thetaf_datalist.RData')
...
ets_opt_pre_list <- load_single_object('Daily_ets_opt_pre_result.RData')
thetaf_opt_pre_list <- load_single_object('Daily_thetaf_opt_pre_result.RData')
...
write.csv(etsall,'ets_Daily_final_res.csv')
...
write.csv(thetafall,'thetaf_Daily_final_res.csv')

time_matrix

write.csv(time_matrix,'Daily_time_matrix.csv')
