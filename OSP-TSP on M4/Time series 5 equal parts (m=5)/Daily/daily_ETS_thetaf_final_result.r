...
etsl=load('Daily_ets_datalist.RData')
ets_datalist <- eval(parse(text = etsl))
thetafl=load('Daily_thetaf_datalist.RData')
...
etsoptl=load('Daily_ets_opt_pre_result.RData')
ets_opt_pre_list<- eval(parse(text = etsoptl))
thetafoptl=load('Daily_thetaf_opt_pre_result.RData')
