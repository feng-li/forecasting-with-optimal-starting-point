...
ets_datalist <- load_single_object('week_ets_datalist.RData')
thetaf_datalist <- load_single_object('week_thetaf_datalist.RData')
...
ets_opt_pre_list <- load_single_object('weekly_ets_opt_pre_result.RData')
thetaf_opt_pre_list <- load_single_object('weekly_thetaf_opt_pre_result.RData')
