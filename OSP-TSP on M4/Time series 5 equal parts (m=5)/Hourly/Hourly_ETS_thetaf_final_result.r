...
ets_datalist <- load_single_object('Hourly_ets_datalist.RData')
thetaf_datalist <- load_single_object('Hourly_thetaf_datalist.RData')
...
ets_opt_pre_list <- load_single_object('Hourly_ets_opt_pre_result.RData')
thetaf_opt_pre_list <- load_single_object('Hourly_thetaf_opt_pre_result.RData')
