...
pre_forecast_thetaf=function(data,freq,h,m,n,train_index)
{
    data_length=length(data)
...
datalist=pre_forecast_thetaf(data,12,18,10,4,trainindex)

save(datalist, file = "Monthly_thetaf_datalist.RData")
