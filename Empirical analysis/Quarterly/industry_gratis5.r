...
save(gratislist,file='gratislist_china_industry_50.RData')

gratislist <- load_single_object('gratislist_china_industry_50.RData')
gratislist[[1]]
...
write.csv(alltest,'industry_index_gratis_12.csv')
