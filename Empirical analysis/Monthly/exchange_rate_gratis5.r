...
save(gratislist,file='gratislist_exchange_rate_50_12.RData')

gratislist <- load_single_object('gratislist_exchange_rate_50_12.RData')
gratislist[[1]]
...
write.csv(alltest,'exchange_rate_gratis_12.csv')
